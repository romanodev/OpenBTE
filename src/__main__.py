...
def main(args=None):
 ...
 parser.add_argument('--n_mfp', help='Number of mfps',default=10)
 ...
 parser.add_argument('--n_x',default=3,help='Repetition along x')
 parser.add_argument('--n_y',default=3,help='Repetition along y')
 ...
 if not args.material == None:
  Material(filename=args.material,grid=[int(args.n_mfp),int(args.n_theta),int(args.n_phi)])
