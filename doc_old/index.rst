...
.. image:: _figures/GettingStarted_1.png
   :width: 60 %
   :align: center
...
.. image:: _figures/GettingStarted_2.png
   :width: 60 %
   :align: center
...
The solver will first solve the diffusion equation to provide the first guess for the pseudotemperature, then it will solve the BTE. If you run it in serial on your laptop, it should take a few minutes. In this case, the thermal conductivity is about 
